    ...
    <div style={{ minHeight: "100vh", background: "#F9FAFB", color: "#0F172A", fontFamily: "inherit" }}>
      ...
      <main style={{ maxWidth: 880, margin: "0 auto", padding: "60px 32px" }}>
        ...
        <p style={{ color: "#475569", fontSize: 14, marginBottom: 40 }}>
          ...
          Belge eksikse: <a href="mailto:support@erpaio.com" style={{ color: "#0A0A0A" }}>support@erpaio.com</a>
        </p>

        {sections.map((s) => (
          <section key={s.title} style={{ marginBottom: 36 }}>
            <h2 style={{ fontSize: 14, color: "#0A0A0A", marginBottom: 16 }}>{s.title}</h2>
        ...
        <div style={{ background: "#FFFFFF", border: "1px solid #E5E7EB", borderRadius: 8, padding: 20, marginTop: 40, fontSize: 12, color: "#475569", lineHeight: 1.7 }}>
          <strong style={{ color: "#0A0A0A" }}>Pilot kullanıcısıysanız:</strong> Onboarding sürecinde Customer Success ekibimizle 1-2 saatlik kurulum görüşmesi yapacağız. Anlam çıkmayan tablolar için annotation girişi, anomaly threshold tuning, custom rapor talep edebilirsiniz.
        </div>
      </main>
