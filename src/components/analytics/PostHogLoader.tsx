...
posthog.init(${JSON.stringify(postHogKey)},{api_host:${JSON.stringify(apiHost)},persistence:"memory",autocapture:false,capture_pageview:true,capture_pageleave:false,disable_session_recording:true});`;
