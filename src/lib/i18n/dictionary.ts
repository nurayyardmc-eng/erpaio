...
export interface Dictionary {
  ...
  billing: {
    ...
    providerIyzico: string;
    providerManual: string;
    noProvider: string;
    iyzicoFormTitle: string;
    iyzicoFormDescription: string;
    iyzicoName: string;
    iyzicoSurname: string;
    iyzicoIdentityNumber: string;
    iyzicoIdentityHint: string;
    iyzicoGsm: string;
    iyzicoGsmHint: string;
    iyzicoCity: string;
    iyzicoAddress: string;
    iyzicoZip: string;
    iyzicoCountry: string;
    ...
    cancelSuccessStripe: string;
    cancelSuccessIyzico: string;
    cancelFailed: string;
    selectPlanPro: string;
    selectPlanEnterprise: string;
    invoiceNoteIyzico: string;
  };
  insights: {
    breadcrumb: string;
    title: string;
