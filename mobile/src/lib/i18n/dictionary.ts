...
export interface Dictionary {
  ...
  alerts: {
    ...
    emptyAckedTitle: string;
    emptyOpenDesc: string;
    emptyAckedDesc: string;
    sevCritical: string;
    sevHigh: string;
    sevMedium: string;
    sevLow: string;
    ackBtn: string;
    bulkSelectedSuffix: string;
    bulkAck: string;
    bulkResolve: string;
    bulkCancel: string;
    bulkSuccessAcked: (n: number) => string;
    bulkSuccessResolved: (n: number) => string;
    bulkErrorToast: string;
    selectHint: string;
    selectToggleHint: string;
    detailBrand: string;
    back: string;
    ...
    ackBtnLabel: string;
    resolveBtnFromOpen: string;
    resolveBtnFromAcked: string;
    resolveConfirmTitle: string;
    resolveConfirmMessage: string;
    confirmYes: string;
    ackedToast: string;
    resolvedToast: string;
    actionFailedToast: string;
    fpConfirmTitle: string;
    fpConfirmMessage: string;
    fpConfirmYes: string;
    fpMarkBtn: string;
    fpClearBtn: string;
    fpMarkedToast: string;
    fpClearedToast: string;
  };
  activity: {
    brand: string;
    title: string;
