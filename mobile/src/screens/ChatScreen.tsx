...
const styles = StyleSheet.create({
  ...
  backText: { color: colors.accent, fontFamily: font, fontSize: 12 },
  connChip: {
  ...
  connChipActive: { borderColor: colors.accent, backgroundColor: colors.accentMuted },
  connChipText: { color: colors.textMuted, fontFamily: font, fontSize: 10 },
  connChipTextActive: { color: colors.accent },
  ...
  userText: { color: colors.text, fontFamily: font, fontSize: 13 },
  dimText: { color: colors.textDim, fontFamily: font, fontSize: 10 },
  errorBubble: {
  ...
  errorText: { color: colors.danger, fontFamily: font, fontSize: 12 },
  sqlBlock: {
  ...
  cachedBadge: { borderColor: colors.cached, borderWidth: 1, borderRadius: radius.sm, paddingHorizontal: spacing(1.5) },
  cachedText: { color: colors.cached, fontFamily: font, fontSize: 8, letterSpacing: 1 },
  sqlText: { color: "#8EC8E8", fontFamily: font, fontSize: 11 },
  tableScroll: { borderColor: colors.border, borderWidth: 1, borderRadius: radius.md },
